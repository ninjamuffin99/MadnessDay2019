...
{
	public override function get_valueType():ValueType
	{
		return ValueType.IntType;
	}

	public override function get_isTruthy():Bool
	{
		return value != 0;
	}
...
{ // DONE!
	...
	override function get_isTruthy():Bool
	{
		throw new SystemException("Shouldn't be checking the truthiness of a divert target");
		return false;
	}
...
{ // DONE!
	...
	public override function get_isTruthy()
	{
		throw new SystemException("Shouldn't be checking the truthiness of a variable pointer");
		return false;
	}
