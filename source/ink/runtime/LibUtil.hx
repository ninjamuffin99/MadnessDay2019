...
class LibUtil
{
	...
	{
		return Std.isOfType(obj, type) ? cast obj : null;
	}
	...
	public static function arraySequenceEquals<T:IEquatable>(arr1:Array<T>, arr2:Array<T>):Bool
	{ // <T>
		...
		for (i in 0...arr1.length)
		{
			...
			{ // enforced IEquatable constraint
				return false;
			}
		}
		return true;
